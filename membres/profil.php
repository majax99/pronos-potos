        ...
        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xs-offset-0 col-sm-offset-0 col-md-offset-3 col-lg-offset-3 toppad" >
          ...
          <div class="panel panel-info">
            <div class="panel-heading">
              <h3 class="panel-title"><?php echo $_SESSION['membre_pseudo']?> <!-- <span class= "pull-right"> '<img alt="club" src="'.ROOTPATH.'/img/ligue1/'.$profil['membre_club'].'.png" class=" img-circle img-responsive"/>' </span>--></h3> 
            </div>
            <div class="panel-body">
              <div class="row">
                <div class="col-xs-3 col-md-3 col-lg-3 " align="center"> <?php echo $photo_profil ; ?>  </div>
