...
<div class="container">
    ...
    <div class="row">
        ...
        // Cr√©ation de la date de MAJ du classement
        ...
        $date_MAJ_class = '<em style="font-size:0.8em;">Mis √† jour le '.$date->format('d/m/Y √† H\hi').' </em> ' ;
...
$classementJ1= $bdd->query ('SELECT membre_pseudo , round(sum(coalesce(points,0))) as points
...
$point=0;
            ...
            { 
                if ($classementJ1_2['points'] != $point) { $rang=$i; } //en cas d'ÈgalitÈ entre 2 Èquipes, elles ont le mÍme rang
                
                $membre= $classementJ1_2['membre_pseudo'];
                $classementG_J1[$membre]['rang']=$rang;   // on enregistre les donnÈes dans un tableau pour crÈer le classement
                $classementG_J1[$membre]['point']=$classementJ1_2['points'] ; // on enregistre les donnÈes dans un tableau pour connaitre ls points au dernier classement gÈnÈral
                $i++;
    ...
    /************************************************************************************************/
        ...
        <div class="panel panel-primary filterable ">
            ...
            <div class="panel-heading">
                ...
                <h3 class="panel-title">Classement g√©n√©ral apr√®s <?php echo $nb_match_class ; ?> match(s) <span class= "pull-right hidden-xs"><?php echo $date_MAJ_class ; ?>  </span></h3>
...
if ($donnees['points'] != $point) { $rang=$i; } //en cas d'ÈgalitÈ entre 2 Èquipes, elles ont le mÍme rang
$membre2= $donnees['membre_pseudo'];
$point=$donnees['points'];   
    
  //On dÈfinit les icones de coupe
...
// On dÈfinit l'Èvolution au classement (rang)
...
// On dÈfinit l'Èvolution au classement (points)
